...
request.open("GET", "https://semestriel.framapad.org/p/workshop-w2p-html-a6kf/export/txt");
...
request.addEventListener("readystatechange", function(event) {
    if (request.readyState === XMLHttpRequest.DONE && request.status === 200) {
        ...
        theCss.href = "https://semestriel.framapad.org/p/workshop-w2p-css-a6jt/export/txt";
