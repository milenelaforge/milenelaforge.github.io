...
request.open("GET", "https://semestriel.framapad.org/p/intercalaires-a6tt/export/txt");
...
request.addEventListener("readystatechange", function(event) {
    if (request.readyState === XMLHttpRequest.DONE && request.status === 200) {
        ...
        theCss.href = "https://mensuel.framapad.org/p/intercalaires-css-a6tt/export/txt";
